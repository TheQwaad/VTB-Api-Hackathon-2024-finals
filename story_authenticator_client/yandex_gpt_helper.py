...
YANDEX_GPT_MODELS = {YandexGptModels.LITE, YandexGptModels.PRO}


class YandexGptHelper:
    def __init__(self, directory, api_token=None, iam_token=None, model=YandexGptModels.LITE):
        ...
        self.modelUri = f"gpt://{self.directory}/yandexgpt-lite/latest"
