...
import base.services.nft_staff.data_coders as coders
from base.services.nft_staff.nft_metadata_generator import generate_nft_metadata_url
from base.services.nft_staff.get_nft_data import get_nft_index
...
async def mint_nft(user_id: int, user_address: str) -> None:
    ...
    return nft.address.to_str(is_test_only=IS_TESTNET)
